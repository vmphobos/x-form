...
### Format
The following syntax is used to render a div containing all necessary form parts for your property
```
<x-form.{input, checkbox, radio, select, textarea, disabled, phones} // a
